#!/usr/bin/env sh
# Universal installer for sanctscan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sanctscan.git"
echo "Installing sanctscan ..."
